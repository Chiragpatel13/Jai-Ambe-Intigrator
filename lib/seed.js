...
export async function seedDatabase() {
  try {
    ...
    if (settingsCount === 0) {
      ...
      if (existing && (existing.shopName !== 'JAYAMBE INTEGRATORS' || existing.phone !== '+91 8879430925' || existing.address !== 'Office: Mahavir Nagar, Shop No. 28, Navapur Road, Near to UCO Bank, Boisar (W).')) {
