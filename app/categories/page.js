          ...
          <div className="relative border-l border-gray-200 dark:border-gray-800 ml-4 sm:ml-32 space-y-10">
            {timelineMilestones.map((milestone, idx) => (
              <div key={idx} className="relative pl-6 sm:pl-8 group">
                ...
                <div className="hidden sm:block absolute -left-36 top-1 text-right w-28 text-blue-600 dark:text-blue-400 font-black text-sm">
                  {milestone.year}
                </div>
                {/* Visual marker dot */}
                <div className="absolute -left-1.5 top-2 w-3 h-3 rounded-full bg-blue-600 dark:bg-blue-400 border border-white dark:border-gray-950 group-hover:scale-125 transition-transform" />
                ...
                <div className="space-y-1 bg-gray-50 dark:bg-gray-900/40 p-5 rounded-2xl border border-gray-100 dark:border-gray-900 shadow-sm">
                  <span className="sm:hidden inline-block text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase mb-1">
                    Year {milestone.year}
                  </span>
